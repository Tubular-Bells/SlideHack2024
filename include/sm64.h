...
enum ActionTimerChecks {
	TIME_AIR_JUMP_WAIT = 8
};
...
#define ACT_BOOST_LAND_STOP            0x0C000237 // (0x037 | ACT_FLAG_STATIONARY | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_BOOST_LAND                 0x0400047B // (0x07B | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON)
...
#define ACT_AIR_BOOSTING               0x00000884 // (0x084 | ACT_FLAG_AIR)
...
#define ACT_PLUMMET                    0x0080088F // (0x08F | ACT_FLAG_AIR | ACT_FLAG_ATTACKING)
#define ACT_BOOST_JUMP                 0x00000890 // (0x090 | ACT_FLAG_AIR)
#define ACT_AIR_JUMP                   0x00000891 // (0x091 | ACT_FLAG_AIR)
