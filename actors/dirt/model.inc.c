...
static const Vtx dirt_seg3_vertex_tiny_particle_billboard[] = {
    {{{   -10,     10,      0}, 0, {     0,      0}, {0x0D, 0xF4, 0x98, 0x88}}},
    {{{    10,     10,      0}, 0, {     0,      0}, {0x0D, 0xF4, 0x98, 0x88}}},
    {{{     0,    -10,      0}, 0, {     0,      0}, {0x0D, 0xF4, 0x98, 0x88}}},
};
...
static const Vtx dirt_seg3_vertex_cartoon_star_billboard[] = {
    {{{     0,     -8,      0}, 0, {     0,      0}, {0x0D, 0xF4, 0x98, 0x88}}},
    {{{   -32,     80,      0}, 0, {     0,      0}, {0x0D, 0xF4, 0x98, 0x88}}},
    {{{    32,     80,      0}, 0, {     0,      0}, {0x0D, 0xF4, 0x98, 0x88}}},
    {{{   -52,     28,      0}, 0, {     0,      0}, {0x0D, 0xF4, 0x98, 0x88}}},
    {{{  -116,     80,      0}, 0, {     0,      0}, {0x08, 0xBB, 0xEA, 0xFF}}},
    {{{   -84,    -52,      0}, 0, {     0,      0}, {0x08, 0xBB, 0xEA, 0xFF}}},
    {{{    52,     28,      0}, 0, {     0,      0}, {0x0D, 0xF4, 0x98, 0x88}}},
    {{{    84,    -52,      0}, 0, {     0,      0}, {0x08, 0xBB, 0xEA, 0xFF}}},
    {{{   116,     80,      0}, 0, {     0,      0}, {0x08, 0xBB, 0xEA, 0xFF}}},
    {{{     0,    160,      0}, 0, {     0,      0}, {0x08, 0xBB, 0xEA, 0xFF}}},
};
